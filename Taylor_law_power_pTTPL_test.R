...
##MPD
beta_summary_all = data.frame(Plot=character(), Intercept=double(),	Beta=double(), R2=double(), P=double())
for(i in 1:length(Plot_list)){
  ...
  summary_name <- paste("./Taylor/Archaea/",Plot_list[i],"_MPD_weighted_otu_mean_var_summary.csv", sep='')
  write.csv(all_summary, summary_name, quote = FALSE)
  plot_name <- paste("./Taylor/Archaea/",Plot_list[i],"_MPD_weighted_otu_mean_var_point_fit_line.pdf",sep="")
  par(mar=c(3,5,2,2))
...
write.csv(beta_summary_all, "./Taylor/Archaea/MPD_weighted_otu_Taylor_beta.csv", quote = FALSE, row.names = FALSE)
...
for(i in 1:length(Plot_list)){
  ...
  all_summary["LogMean"] <- log10(all_summary$Mean)
  all_summary["LogVar"] <- log10(all_summary$Variance)
  summary_name <- paste("./Taylor/Bacteria/",Plot_list[i],"_MPD_weighted_otu_mean_var_summary.csv", sep='')
  write.csv(all_summary, summary_name, quote = FALSE)
  plot_name <- paste("./Taylor/Bacteria/",Plot_list[i],"_MPD_weighted_otu_mean_var_point_fit_line.pdf",sep="")
  par(mar=c(3,5,2,2))
  p <- ggplot(data = all_summary, aes(x = LogMean, y = LogVar)) +
    geom_point(size=1)  +
    geom_smooth(method="lm" , formula = y~x, color="#009E73", fill="#56B4E9", se=TRUE,linetype = "dashed",linewidth=1) 
...
write.csv(beta_summary_all, "./Taylor/Bacteria/MPD_weighted_otu_Taylor_beta.csv", quote = FALSE, row.names = FALSE)
...
for(i in 1:length(Plot_list)){
  ...
  all_summary["LogMean"] <- log10(all_summary$Mean)
  all_summary["LogVar"] <- log10(all_summary$Variance)
  summary_name <- paste("./Taylor/Fungi/",Plot_list[i],"_MPD_weighted_otu_mean_var_summary.csv", sep='')
  write.csv(all_summary, summary_name, quote = FALSE)
  plot_name <- paste("./Taylor/Fungi/",Plot_list[i],"_MPD_weighted_otu_mean_var_point_fit_line.pdf",sep="")
  par(mar=c(3,5,2,2))
  p <- ggplot(data = all_summary, aes(x = LogMean, y = LogVar)) +
    geom_point(size=1)  +
    geom_smooth(method="lm" , formula = y~x, color="#009E73", fill="#56B4E9", se=TRUE,linetype = "dashed",linewidth=1) 
...
write.csv(beta_summary_all, "./Taylor/Fungi/MPD_weighted_otu_Taylor_beta.csv", quote = FALSE, row.names = FALSE)
...
for(i in 1:length(Plot_list)){
  ...
  all_summary["LogMean"] <- log10(all_summary$Mean)
  all_summary["LogVar"] <- log10(all_summary$Variance)
  summary_name <- paste("./Taylor/Protists/",Plot_list[i],"_MPD_weighted_otu_mean_var_summary.csv", sep='')
  write.csv(all_summary, summary_name, quote = FALSE)
  plot_name <- paste("./Taylor/Protists/",Plot_list[i],"_MPD_weighted_otu_mean_var_point_fit_line.pdf",sep="")
  par(mar=c(3,5,2,2))
  p <- ggplot(data = all_summary, aes(x = LogMean, y = LogVar)) +
    geom_point(size=1)  +
    geom_smooth(method="lm" , formula = y~x, color="#009E73", fill="#56B4E9", se=TRUE,linetype = "dashed",linewidth=1) 
...
write.csv(beta_summary_all, "./Taylor/Protists/MPD_weighted_otu_Taylor_beta.csv", quote = FALSE, row.names = FALSE)
...
beta_summary_all = data.frame(Plot=character(), Intercept=double(),	Beta=double(), R2=double(), P=double())
for(i in 1:length(Plot_list)){
  data_name = paste("./data/Nematoda/", Plot_list[i], "_MPD_weighted_otu_All_abun.csv",sep="")
  subcom = read.csv(data_name, header=T, row.names =1)
  all_summary <- data.frame(Mean = double(), Var = double())
  for(j in 1:nrow(subcom)){
    abun <- as.numeric(subcom[j,])
  ...
  all_summary["LogMean"] <- log10(all_summary$Mean)
  all_summary["LogVar"] <- log10(all_summary$Variance)
  summary_name <- paste("./Taylor/Nematoda/",Plot_list[i],"_MPD_weighted_otu_mean_var_summary.csv", sep='')
  write.csv(all_summary, summary_name, quote = FALSE)
  plot_name <- paste("./Taylor/Nematoda/",Plot_list[i],"_MPD_weighted_otu_mean_var_point_fit_line.pdf",sep="")
  par(mar=c(3,5,2,2))
  p <- ggplot(data = all_summary, aes(x = LogMean, y = LogVar)) +
    geom_point(size=1)  +
    geom_smooth(method="lm" , formula = y~x, color="#009E73", fill="#56B4E9", se=TRUE,linetype = "dashed",linewidth=1) 
...
write.csv(beta_summary_all, "./Taylor/Nematoda/MPD_weighted_otu_Taylor_beta.csv", quote = FALSE, row.names = FALSE)
